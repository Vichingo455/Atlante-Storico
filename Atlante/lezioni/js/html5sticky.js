...
var max_notes = 1; // maximum number of notes one can store
...
html5sticky.addNote = function(){
    ...
    if (tnotes === max_notes){
       alert('Non puoi aggiungere ulteriori commenti.');
       return false;
    }
    ...
    $(stickynote).append($('<p>Scrivi qui...</p>'));
    // append identifier
	...
	///////////////////////////prova/////////////////////////
	if (! $("#removenotestext").is(':visible')){
       $('#removenotestext').slideDown('slow');
    }
...
html5sticky.deleteAllNotes = function(){
    if (confirm('Sei sicuro di voler cancellare TUTTI i commenti?')){
...
html5sticky.editNote = function($clone, el){
   ...
   // put in Close button
   $('<a href="#" class="close_stickynote"><img src="../images/close.png" alt="" title="close note"></a>')
      .css({
         position:'absolute',
         top:7,
         right:5
   ...
   // put in Save button
   $('<a href="#" class="save_stickynote"><img src="../images/save.png" alt="" title="save note"></a>')
      .css({
         position:'absolute',
         top:7,
         right:60
